...
structGenConfigControll = sgen.StructGenConfig(cellSize = 100, pointsPerCell = 1, dispersion= 1.0, standardDeviation = stdDevControllPoints, approach = "uniform", typeOfPoints= "controll")
...
for runId in range(0,N):
    ...
    for sample in range(0,NumOfSamples):
        ...
        time.sleep(2) #this is important to set - we have to wait until solver finishes
